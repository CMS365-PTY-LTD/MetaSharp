        ...
        public struct GraphAPI
        {
            ...
            public struct Page
            {
                public struct Fields
                {
                    ...
                    ",leadgen_tos_accepting_user,link,location,members,merchant_review_status,messaging_feature_status,messenger_ads_default_icebreakers" +
                    ...
                    ",payment_options,personal_info,personal_interests,pharma_safety_info,phone" +
                    ",promotion_eligible,promotion_ineligible_reason,public_transit,rating_count,record_label,release_date,restaurant_services,restaurant_specialties,schedule,screenplay_by,season" +
                    ",starring,start_info,store_code,store_location_descriptor,store_number,studio,supports_donate_button_in_live_video" +
                    ",unseen_message_count,username,verification_status,voip_info";
